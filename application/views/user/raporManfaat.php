                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                ...
                                                <a class="btn btn-outline-danger btn-xs" href="<?php echo base_url() . 'manfaatuser/hapus_manfaat/' . $m['id_manfaat'] ?> " onClick='return confirm("Apakah anda yakin ingin menghapus data ini?")'><i class="fas fa-trash"></i></a>
                                            <?php
                                            } else { ?>
                                                <a class="btn btn-outline-info btn-xs " data-toggle="modal" data-target="#detailManfaat<?= $m['id_manfaat'] ?>"><i class="fas fa-search"></i></a>
                                            <?php } ?>
