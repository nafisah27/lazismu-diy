    ...
    $(function() {
        ...
        $("#kategori").change(function() {
            ...
            if (value > 0) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url('manfaatuser/ambil_data') ?>",
                    data: {
                        modul: 'kategori',
                        id: value
                    },
...
<script type="text/javascript">
    $(function() {
        ...
        // $.ajaxSetup({
        //     type: "POST",
        //     url: "<?php echo base_url('distribusiuser/ambil_data') ?>",
        //     cache: false,
        // });
...
<script>
    ...
    $(function() {
        ...
        $("#tahunAsnaf").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('distribusiuser/load_asnaf') ?>",
                data: {
                    modul: value
                },
    ...
    $(function() {
        ...
        $("#tahunProgram").change(function() {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('distribusiuser/load_program') ?>",
                data: {
                    modul: value
                },
